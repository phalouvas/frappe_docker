...
- Export apps to variable and build image
  ...
  docker build  --no-cache --build-arg=FRAPPE_PATH=https://github.com/frappe/frappe \
    ...
    --tag=phalouvas/erpnext-worker:14.62.3 \
    --file=images/custom/Containerfile .

  docker push phalouvas/erpnext-worker:14.62.3
  docker tag phalouvas/erpnext-worker:14.62.3 phalouvas/erpnext-worker:version-14
...
- Export apps to variable and build image
  ...
  docker build  --no-cache --build-arg=FRAPPE_PATH=https://github.com/frappe/frappe \
    ...
    --build-arg=APPS_JSON_BASE64=$APPS_JSON_BASE64 \
    --tag=phalouvas/erpnext-worker:15.13.0 \
    --file=images/custom/Containerfile .

  docker push phalouvas/erpnext-worker:15.13.0
  docker tag phalouvas/erpnext-worker:15.13.0 phalouvas/erpnext-worker:version-15
