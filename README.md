...
- Build worker image to include hrms with command in folder images/kainotomo `docker build --no-cache -f ./images/kainotomo/Containerfile . --tag phalouvas/erpnext-worker:14.55.0`
...
### Development Server
- Fetch from remotes
- Fix version 14.55.0 to new in repository gitops
...
- Export apps to variable and build image
  ...
  docker build  --no-cache --build-arg=FRAPPE_PATH=https://github.com/frappe/frappe \
    ...
    --tag=phalouvas/erpnext-worker:14.55.0 \
    --file=images/custom/Containerfile .

  docker push phalouvas/erpnext-worker:14.55.0
  docker tag phalouvas/erpnext-worker:14.55.0 phalouvas/erpnext-worker:version-14
...
- Export apps to variable and build image
  ...
  docker build  --no-cache --build-arg=FRAPPE_PATH=https://github.com/frappe/frappe \
    ...
    --build-arg=APPS_JSON_BASE64=$APPS_JSON_BASE64 \
    --tag=phalouvas/erpnext-worker:15.7.0 \
    --file=images/custom/Containerfile .

  docker push phalouvas/erpnext-worker:15.7.0
  docker tag phalouvas/erpnext-worker:15.7.0 phalouvas/erpnext-worker:version-15
