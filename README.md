...
- Build worker image to include hrms with command in folder images/kainotomo `docker build --no-cache -f ./images/kainotomo/Containerfile . --tag phalouvas/erpnext-worker:14.38.0`
...
- Update accordingly file images/kainotomo/Containerfile with latest branches e.g. 
  - for erpnext from 14.38.0 to x.x.x
  - and frappe from 14.48.1 to x.x.x
- Create new image `docker build --no-cache -f ./images/kainotomo/Containerfile . --tag phalouvas/erpnext-worker:14.38.0` where 14.38.0 the erpnext version
...
- `docker push phalouvas/erpnext-worker:14.38.0`
...
- `git pull`
- `docker pull phalouvas/erpnext-worker:14.38.0`
- Run 
  - `docker compose down`
  - `docker compose up -d`
